function [ circleArcPointMat, numberPoints ] = calculatepointsnecirculararc...
    ( radius, arcAngleRad, initialArcAngleRad, centerVec, resolution, want2see )
%lsb code
% [ circleArcPointMat, numberPoints ] = calculatepointsnecirculararc...
%    ( radius, arcAngleRad, initialArcAngleRad, centerVec, resolution, want2see )
%Description:
%Draws an in plane circular arc in the north-east coordinate system
%
%Nested function(s):
%nepol2cart
%
...
[circleArcPointMat3(:,1), circleArcPointMat3(:,2)] =nepol2cart(theta ,rho);
...
if want2see ==true
	...
	axis( [centerVec(1)-radius ,centerVec(1)+radius ,centerVec(2)-radius ,centerVec(2)+radius] ,'square' );
%    hold off;
end
end
